...
@section('main')
    ...
    <h1 class="mt-5">Tienda River Plate</h1>
    ...
    @auth
    <a href="{{route('tienda.agregar.form')}}" class="btn btn-danger mb-5">+ Agregar un producto</a>
    @endauth
        ...
        <div class="card-body">
            ...
            <div>
                <form action="{{ route('tienda.eliminar', ['id'=> $producto->producto_id])}}" method="post">
                    @csrf
                    <button type="sumbit" class="btn btn-dark w-100 mt-3">Eliminar</button>
                </form>
            </div>
            @endauth
        </div>
